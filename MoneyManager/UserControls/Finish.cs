...
namespace MoneyManager.UserControls
{
    public partial class Finish : UserControl
    {
        ...
        Wallet wal;
        public Finish(Account data, Wallet wal)
        {
            InitializeComponent();
            acc = data;
            this.wal = wal;
        ...
        {
            List<Budget> list = wd.GetFinishBudgetsByAccId(acc.AccountId, wal.WalletId);
            if (list != null)
            {
                foreach (Budget b in list)
                {
                    ...
                    lblLeft.Location = new Point(592, 54);
                    ...
                    lblLeft.TextAlign = ContentAlignment.MiddleRight;
                    // 
                    // guna2ProgressBar1
                    // 
                    ...
                    lblAmount.Location = new Point(587, 37);
